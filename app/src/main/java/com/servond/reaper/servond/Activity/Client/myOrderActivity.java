...
public class myOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner=(ProgressBar)findViewById(R.id.myOrderProgressBar);
        spinner.setVisibility(View.VISIBLE);

        adapter = new OrderAdapter(listOrders, context);
        recyclerView = (RecyclerView) findViewById(R.id.myListOrder);
        ...
        String url = "https://servond.000webhostapp.com/show_my_order.php?username="+username;
